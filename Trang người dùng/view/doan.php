	...
	<section class="container">
		...
		<div class="prodoan">
			<div class="prodo">
				...
				<p>Giá: 125.000đ</p>
				<input class="btn btn-md btn--warning " type="number" name="soluong" min="1" max="10" value="1">
				<label class="btn btn-md btn--danger " for="myCheck"> ĐẶT NGAY </label>
		...
		</div><div class="reservation-form12">
