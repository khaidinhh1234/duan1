...
<section class="container">
    <div class="col-sm-12">
        ...
        <div class="movie movie--preview movie--full comments">
            ...
            <a href="index.php?act=ctphim&id" class="movie__title link--huge"><?= $phim['tieu_de']?></a>
            ...
            <p class="movie__option"><strong>Đạo diễn: </strong><a href="#">VETOR VŨ</a></p>
            <p class="movie__option"><strong>Diễn viên: </strong><a href="#">Kaity Nguyễn</a>, <a href="#">Thuận</a>, <a href="#">Morgan Freeman</a>, <a href="#">Kevin Kline</a>, <a href="#">Mary Steenburgen</a>, <a href="#">Jerry Ferrara</a>, <a href="#">Romany Malco</a> <a href="#">...</a></p>
            <p class="movie__option"><strong>Giới hạn độ tuổi: </strong><a href="#">+16</a></p>
