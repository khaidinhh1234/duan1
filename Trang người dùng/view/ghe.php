            ...
            <div class="choose-sits">
                <div class="choose-sits__info choose-sits__info--first">
                    <ul>
                        ...
                        <li class="sits-price sits-price--cheap">100.000 Đồng</li>
                        <li class="sits-price sits-price--middle">200.000 Đồng</li>
                        <li class="sits-price sits-price--expensive">300.000 Đồng</li>
                    </ul>
                </div>
...
<form id='film-and-time' class="booking-form" method='get' action='index.php?act=thanhtoan'>
    ...
    <div class="booking-pagination booking-pagination--margin">
        <a href="index.php?act=datve" class="booking-pagination__prev">
            <span class="arrow__text arrow--prev">prev step</span>
            <span class="arrow__info">what&amp;where&amp;when</span>
        </a>
        <a href="index.php?act=doan" class="booking-pagination__next">
